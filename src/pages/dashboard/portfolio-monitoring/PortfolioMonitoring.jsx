      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <img
            ...
            onError={(e) => {
              e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(b.name)}&background=132040&color=fff&size=40`;
            }}
          />
          <div>
...
export default function PortfolioMonitoring() {
  ...
  const pad = isMobile ? "1.25rem 1rem" : "28px 32px";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", gap: "20px", marginTop: "8px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <div
                style={{ width: 14, height: 2, backgroundColor: "#F8CE75" }}
              />
              <span style={{ fontSize: "11px", color: "#64748B" }}>
                Default Rate
              </span>
      ...
      {/* ── Borrower Table / Cards ── */}
      {isMobile ? (
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {borrowers.map((b) => (
            <BorrowerCard key={b.id} b={b} />
          ))}
        </div>
      ) : (
        <div
              ...
              <tbody>
                {borrowers.map((b, i) => (
                  <tr
                    key={b.id}
                    style={{
                      backgroundColor: i % 2 === 0 ? "#132040" : "#0F1E35",
                      cursor: "pointer",
